export default () => (
  <div className='grid-example'>
    <div className='container'>
      <input type='checkbox' checked id='dense' className='hide' onChange={(e) => { console.log('changed')}}/>
      <div className='wrap'>
	...
	<figure><img src='https://unsplash.it/900/650?image=19' alt='' />
        <figcaption>More '#impoCSSible inside' <a href='https://escss.blogspot.com/search/label/demo'>my blog 👍</a></figcaption>
	</figure>
	...
	<figure><img src='https://unsplash.it/900/350?image=46' alt='' /></figure>
      ...
      <label id='dense'>change the value of <span>grid-auto-flow:</span> look at the Nº & empty spaces<br/>IDEA: resize the window</label>
    </div>
    <style jsx global>{`
      .grid-example {
        margin: 0;
